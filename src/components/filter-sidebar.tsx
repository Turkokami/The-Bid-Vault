...
export function FilterSidebar(props: FilterSidebarProps) {
  ...
  return (
    <aside className="xl:sticky xl:top-36 xl:h-fit">
      ...
      <div className={`mt-2 space-y-4 rounded-[2rem] border border-white/10 bg-slate-950/80 p-5 shadow-[0_16px_50px_rgba(0,0,0,0.35)] backdrop-blur xl:mt-0 xl:block ${mobileOpen ? "block" : "hidden xl:block"}`}>
      <div className="mb-2">
